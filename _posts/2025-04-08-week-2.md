...
<img src="/assets/img/posts/2025-04-08/MainMenuUI.PNG" alt="An image displaying the main menu UI for Travelling with Taste." width="200"/>

We've created a functional main menu (set in a temporary scene).

<img src="/assets/img/posts/2025-04-08/ScrollingCreditsUI.PNG" alt="An image of the credits UI." width="200"/>

Clicking on the "Credits" button will take you a screen with scrolling credits for our game.

<img src="/assets/img/posts/2025-04-08/CheeseButtonImproved.png" alt="An image of our UI button background sprite." width="200"/>

We've created a sample UI button which we will implement in the coming days.

<img src="/assets/img/posts/2025-04-08/CollectableCheeseUI.PNG" alt="an image of the in-game UI with a counter for collected cheese at the top left and a countdown timer at the top right." width="200"/>

<iframe width="560" height="315" src="https://youtu.be/WLlUFXyLG2w" frameborder="0" allowfullscreen></iframe>
...
<img src="/assets/img/posts/2025-04-08/AirportAgentBack.png" alt="The security agent model from the back." width="200"/>
<img src="/assets/img/posts/2025-04-08/AirportAgentFront.png" alt="The security agent model from the front." width="200"/>

These are front and back pictures of our model.

<img src="/assets/img/posts/2025-04-08/AirportAgentSculpt.png" alt="The mesh for the security agent." width="200"/>

Here is a sculpt of the Airport Security Agent without any textures.

<img src="/assets/img/posts/2025-04-08/ButtonAndConveyorBelt.png" alt="An in-progress development scene showing work-in-progress models for the button and conveyor belt." width="200"/>

Next, we modeled a conveyer belt asset and a sample button. Both of these were created, textured, and imported into the game.

<img src="/assets/img/posts/2025-04-01/art_zhou_suitcase.png" alt="The model for the player character, the suitcase." width="200"/>

Finally, we've made an updated version of our player character, the suitcase.

### Animations

<img src="/assets/img/posts/2025-04-08/ButtonAnimationExample.gif" alt="A development scene displaying the newest button model and its press animation." width="200"/>

We've created a button press animation as well.

<img src="/assets/img/posts/2025-04-08/ConveyorDirection.gif" alt="A short video illustrating the scrolling mask used for the conveyor belt model." width="200"/>
...
<iframe width="560" height="315" src="https://youtu.be/lPcUJrtUn1c" frameborder="0" allowfullscreen></iframe>
...
<iframe width="560" height="315" src="https://youtu.be/VxGHQPylZnE" frameborder="0" allowfullscreen></iframe>
